...
public class WoodenBarrel0BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WoodenBarrel0BlockEntity(BlockPos position, BlockState state) {
		super(RakinatorModBlockEntities.WOODEN_BARREL_0.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("wooden_barrel_0");
	}
