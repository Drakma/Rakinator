...
import net.drakma.rakinator.procedures.CeramicBucketMilkFoodEatenProcedure;
import net.drakma.rakinator.init.RakinatorModTabs;

public class CeramicBucketMilkItem extends Item {
	public CeramicBucketMilkItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		CeramicBucketMilkFoodEatenProcedure.execute(entity);
		return retval;
	}
}
