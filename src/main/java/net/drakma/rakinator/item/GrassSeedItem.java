...
import net.drakma.rakinator.procedures.GrassSeedRightClickedProcedure;
...
public class GrassSeedItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		GrassSeedRightClickedProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
