...
import net.drakma.rakinator.procedures.CarrotSeedRightClickedProcedure;
...
public class CarrotSeedItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		CarrotSeedRightClickedProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
